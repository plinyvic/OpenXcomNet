 ...
 */
UnitWalkBState::UnitWalkBState(BattlescapeGame* parent, const BattleAction& action) : BattleState(parent, action), _unit(0), _pf(0), _terrain(0), _beforeFirstStep(false), _numUnitsSpotted(0), _preMovementCost(0)
{
